...
set feed off
set head off
spool $UNXLOG/Name_details95.log
declare
  v_code number := 0; 
  v_date_trait date;
...
begin
    ...
    SELECT to_char(sysdate,'YYYYMMDDHH24MI')||'_Name_details95.log' INTO v_ficlog FROM dual ;
	
  

V_code := SCHEMA2.PACKAGE_PXCR95.MAIN_CR95(v_ficlog,v_date_trait); 
